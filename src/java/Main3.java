...
public class Main3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RoundRobin planificador1 = new RoundRobin(memoria,5);
        SRTF planificador2 = new SRTF(memoria);
        FCFS planificador3 = new FCFS(memoria);

        ColasMultinivel colasMultinivel = new ColasMultinivel(planificador1,planificador2,planificador3);

        Simulador simulador = new Simulador(memoria,colasMultinivel,tabla);

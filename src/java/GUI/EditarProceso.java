...
public class EditarProceso {
    ...
    @FXML
    private Button editarProcesoButton;
    ...
    private void setProcesoEnInterfaz() {

        Proceso procesoSeleccionado = TablaProcesos.procesoSeleccionado;

        tamañoProcesoInput.setText(String.valueOf(procesoSeleccionado.getTamano()));
        tiempoArriboInput.setText(String.valueOf(procesoSeleccionado.getTiempoCreacion()));
        //if (!prioridadSpinner.isDisabled() || procesoSeleccionado.getPrioridad()!=0){
        if (!prioridadSpinner.isDisabled()){
            prioridadSpinner.getValueFactory().setValue(procesoSeleccionado.getPrioridad());
        }
        cpu0Input.setText(String.valueOf(procesoSeleccionado.getCpu0()));
        if (procesoSeleccionado.getCpu1()!=0){
            cpu1Input.setText(String.valueOf(procesoSeleccionado.getCpu1()));
            entSalInput1.setText(String.valueOf(procesoSeleccionado.getEs1()));
            if (procesoSeleccionado.getCpu2()!=0){
                cpu2Input.setText(String.valueOf(procesoSeleccionado.getCpu2()));
                entSalInput2.setText(String.valueOf(procesoSeleccionado.getEs2()));
    ...
    private void editarProceso() throws IOException {
        ...
        Proceso viejoProceso = TablaProcesos.procesoSeleccionado;

        proceso.setId(viejoProceso.getId());
        ...
        observableListToStore.remove(TablaProcesos.procesoSeleccionado);
        ...
        Scene scene = editarProcesoButton.getScene();
